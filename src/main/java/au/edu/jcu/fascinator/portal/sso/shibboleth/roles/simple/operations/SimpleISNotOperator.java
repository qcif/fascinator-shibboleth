 ...
 */
public class SimpleISNotOperator implements ShibSimpleRoleOperator {
    private static final Logger logger = LoggerFactory.getLogger(SimpleISNotOperator.class);
    @Override
